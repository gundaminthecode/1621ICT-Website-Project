<?php
    $works = [
        ["icon" => "images/airbrush.jpg", "name" => "Shading With Airbrush", "link" => "techniques/shadingw_airbrush.html"],
    ]
?>
...
<html>
    <head>
        <meta charset="utf-8">
        <title>gundaminthewindow - Techniques</title>
    ...
    <body>
        ...
        <div id="page">
            <ul class="navbar">
                ...
                <li class="navlist"><a class="active" href="techniques.php">Techniques</a></li>
                <li class="navlist"><a href="onlineshop.php">(Online Shop)</a></li>
            </ul>
            <div class="pagecontent">
                <div class="titlebar"><h2>Techniques</h2></div>
                <p></p>
